            ...
            if components.contains(.name) {
                ...
                case .portal:
                    if Accessibility.announcePortalStates {
                        if let portal = self as? Portal, portal.isActive {
                            return NSLocalizedString("active portal", comment: "The localized name for an active portal")
                        }
                        else {
                            return NSLocalizedString("inactive portal", comment: "The localized name for an inactive portal")
                        }
                    }
                    else {
                        return NSLocalizedString("portal", comment: "The localized name for a portal")
                    }
                }
            }
            else {
