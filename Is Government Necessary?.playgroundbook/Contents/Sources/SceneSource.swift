...
@objc (ProxyGeometry) private class ProxyGeometry: SCNGeometry {
    required init?(coder aDecoder: NSCoder) {
        return nil
    }
}

@objc (ProxyMaterial) private class ProxyMaterial: SCNMaterial {
    required init?(coder aDecoder: NSCoder) {
        return nil
    }
}

@objc (ProxyNode) private class ProxyNode: SCNNode {
    required init?(coder aDecoder: NSCoder) {
        return nil
    }
}

@objc (ProxyAnimation) private class ProxyAnimation: CAAnimation {
    required init?(coder aDecoder: NSCoder) {
        return nil
    }
}

@objc (ProxySkinner) private class ProxySkinner: SCNSkinner {
    required init?(coder aDecoder: NSCoder) {
        return nil
    }
}

@objc (ProxyReferenceNode) private class ProxyReferenceNode: SCNReferenceNode {
    required init?(coder aDecoder: NSCoder) {
        return nil
    }
}
