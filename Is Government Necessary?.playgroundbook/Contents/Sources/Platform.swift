...
public final class Platform: Item, NodeConstructible {
    ...
    /**
     Creates a platform on the specified level with the specified platform lock. The platform can then can be placed in the world.
     - parameters:
    ...
    /**
    Creates a platform on the specified level. The platform can then can be placed in the world.
     - parameters:
         - onLevel: The level above the floor the platform should start on. If left out, the level is 2.
